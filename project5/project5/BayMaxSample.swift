...
var val = 0
class BayMaxSample: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        _ = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(BayMaxSample.jumpBall), userInfo: nil, repeats: true)
